...
def show_login_page():
    ...
    with mid:
        ...
        # They get visually "attached" to the top of the white card via CSS
        st.markdown("""
        <div style="
            background:white;
        ...
        # The st.form — CSS makes this the bottom half of the card
        with st.form("login_form", clear_on_submit=False, border=False):
            st.markdown("""
            <style>
            /* Bottom-half of the card — attach to the title div above */
